...
namespace SaltnPepperEngine
{
	namespace Maths
	{
		...
		{
			Quaternion() noexcept : XMFLOAT4{ 0,0,0,1.0f } {}
			constexpr Quaternion(float _valueX, float _valueY, float _valueZ, float _valueW) noexcept : XMFLOAT4(_valueX, _valueY, _valueZ, _valueW) {};
			...
			Quaternion(FXMVECTOR _fxmVector) noexcept { XMStoreFloat4(this, _fxmVector); }
			Quaternion(const XMFLOAT4& _quatVector) noexcept { this->x = _quatVector.x; this->y = _quatVector.y; this->z = _quatVector.z; this->w = _quatVector.w; }
